...
\definecolor{sysured}{RGB}{116,0,3}
\definecolor{sysugold}{RGB}{210,152,101}
\newcommand{\XW}[1]{\textcolor{sysugreen}{{#1}}}
...
\XW{定义、定理等改为如下标准的latex语法格式，这样方便引用，如根据\textbf{定义\ref{def:Lp_space}}。}
